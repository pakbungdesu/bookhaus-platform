...
const inventory_service_1 = __webpack_require__(/*! ./inventory.service */ "./apps/inventory-service/src/inventory.service.ts");
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_all_books' }),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_book' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], InventoryController.prototype, "createBook", null);
__decorate([
...
const inventory_controller_1 = __webpack_require__(/*! ./inventory.controller */ "./apps/inventory-service/src/inventory.controller.ts");
const inventory_service_1 = __webpack_require__(/*! ./inventory.service */ "./apps/inventory-service/src/inventory.service.ts");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: 'admin',
                database: 'test1',
                entities: [shared_1.Book],
                synchronize: false,
                logging: true,
            }),
            typeorm_1.TypeOrmModule.forFeature([shared_1.Book]),
        ],
...
/***/ "./apps/inventory-service/src/inventory.service.ts":
/*!*********************************************************!*\
  !*** ./apps/inventory-service/src/inventory.service.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let InventoryService = class InventoryService {
    ...
    async findAll(query = {}) {
        ...
        if (author)
            where.author = (0, typeorm_2.Like)(`%${author}%`);
...
exports.InventoryService = InventoryService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(shared_1.Book)),
...
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
const inventory_module_1 = __webpack_require__(/*! ./inventory.module */ "./apps/inventory-service/src/inventory.module.ts");
